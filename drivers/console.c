/*
 * @Author: Mengsen.Wang
 * @Date: 2020-10-21 17:53:19
 * @Last Modified by: Mengsen.Wang
 * @Last Modified time: 2020-10-21 18:23:57
 */
...
// 屏幕输出一个字符(带颜色)
/**
 * @brief put one char to console colorful
 */
